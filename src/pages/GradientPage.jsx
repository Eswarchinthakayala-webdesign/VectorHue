...
export default function GradientPage() {
  ...
  return (
    <main className="min-h-screen bg-[#0f0f1b] text-white py-10 px-4 flex flex-col items-center">
      {/* Header and Back Button */}
      <div className="mb-6 flex items-center gap-4 w-full max-w-5xl">
        <Link to="/">
          <Button
            variant="outline"
      ...
      {/* Description */}
      <div className="mt-10 text-white/80 text-sm max-w-3xl border border-purple-300 rounded text-center leading-relaxed px-6">
        <h2 className="text-lg font-semibold text-purple-400 mb-2 mt-6">
          What is a Gradient?
        </h2>
        <p>
