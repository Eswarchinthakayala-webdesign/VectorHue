...
const ScalarPotentialPage = () => {
  return (
    <div className="min-h-screen bg-[#020617] text-white py-10 px-6">
      ...
      <div className="max-w-3xl mx-auto mt-8 border border-purple-500 rounded-lg p-6 bg-[#0f172a] text-center shadow-lg">
        <p className="text-lg text-slate-300">
          A vector field is <span className="text-white font-semibold">conservative</span> if it can be written as the gradient of a scalar function.
        </p>
        <p className="text-2xl mt-3 text-purple-300 font-mono font-semibold">
          ∇ϕ = F
        </p>
        <p className="mt-3 text-slate-400">
          This tool finds ϕ such that the given vector field F = ⟨F<sub>x</sub>, F<sub>y</sub>, F<sub>z</sub>⟩ is the gradient of ϕ.
        </p>
      </div>
    </div>
  );
